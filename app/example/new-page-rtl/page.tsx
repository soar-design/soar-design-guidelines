...
export default function AllPropertiesRTL({
    ...
    return (
        <DirectionProvider dir="rtl">
            <div className="flex min-h-screen w-full flex-col items-center bg-background pt-20" dir="rtl">
                            ...
                            {mounted && (
                                <Tabs value={theme || "system"} onValueChange={(value) => setTheme(value)}>
                                    <TabsList className="h-9 px-1 rounded-full border border-border">
                                        <TabsTrigger value="light" className="rounded-full" title={translations.theme.light}>
                                            <Sun className="h-4 w-4" />
                                        </TabsTrigger>
                                        <TabsTrigger value="dark" className="rounded-full" title={translations.theme.dark}>
                                            <Moon className="h-4 w-4" />
                                        </TabsTrigger>
                                        <TabsTrigger value="system" className="rounded-full" title={translations.theme.system}>
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl">
                                        ...
                                        <Button
                                            ...
                                            aria-label={translations.bookmark}
                                        >
                                            <Bookmark className="h-4 w-4" />
                                        </Button>
                                        <div className="absolute bottom-2 start-2 flex items-center">
                                            <Badge variant="secondary" className="rounded-e-full rounded-s-none">
                                            ...
                                            <Separator orientation="vertical" className="h-5" />
                                            <Badge variant="secondary" className="rounded-e-none rounded-s-full">
                                                {property.area} {translations.areaUnit}
                                            </Badge>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Badge variant="secondary">
                                                ...
                                                {translations.propertyType[property.type as keyof typeof translations.propertyType] || property.type}
                                            </Badge>
                                            <Badge variant="secondary">
                                                <Map className="h-3 w-3" />
                                                {translations.status[property.status as keyof typeof translations.status] || property.status}
                                            </Badge>
                                        </div>
                                ...
                                <div className="flex items-center justify-between border-t border-border pt-6">
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <p className="text-xs leading-4 text-muted-foreground">
                                            {translations.paymentTerms[property.terms as keyof typeof translations.paymentTerms] || property.terms}
                                        </p>
                                    </div>
