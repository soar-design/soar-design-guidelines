...
export default function ShimmeringTextHero() {
  return (
    <div className="flex min-h-[400px] items-center justify-center bg-gradient-to-b from-background to-muted/20 p-8">
      <div className="max-w-4xl text-center">
        ...
        <p className="text-lg text-muted-foreground">
          Create stunning user experiences with our component library
        </p>
      </div>
    </div>
  );
