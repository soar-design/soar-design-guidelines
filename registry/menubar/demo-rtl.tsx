    ...
    <Menubar dir="rtl">
      ...
      <MenubarMenu>
        ...
        <MenubarContent>
          ...
          <MenubarCheckboxItem checked>إظهار عناوين URL الكاملة دائمًا</MenubarCheckboxItem>
          <MenubarSeparator />
          <MenubarItem inset>
      ...
      <MenubarMenu>
        ...
        <MenubarContent>
          <MenubarRadioGroup value="benoit">
            <MenubarRadioItem value="andy">أندي</MenubarRadioItem>
            <MenubarRadioItem value="benoit">بينوا</MenubarRadioItem>
            <MenubarRadioItem value="Luis">لويس</MenubarRadioItem>
          </MenubarRadioGroup>
          <MenubarSeparator />
