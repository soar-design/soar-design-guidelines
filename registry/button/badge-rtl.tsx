  ...
  return (
    <div className="flex flex-col items-center gap-10">
      <Button variant="outline" mode="icon" className="relative">
        <Bell />
        <span className="border-2 border-background rounded-full size-3 bg-primary absolute -top-1 -start-1 animate-bounce" />
      </Button>
      ...
      <Button variant="outline" mode="icon" className="relative">
        ...
        <Badge
          ...
          shape="circle"
          size="sm"
          className="absolute top-0 end-full -translate-y-1/2 translate-x-1/2 rtl:-translate-x-1/2"
        >
          5
        </Badge>
      </Button>
