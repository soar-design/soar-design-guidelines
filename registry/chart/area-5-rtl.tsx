...
const financeData = {
  ...
  week: [
    { month: "الاثنين", totalDeposits: 4.2, totalBorrowed: 3.1 },
    { month: "الثلاثاء", totalDeposits: 4.3, totalBorrowed: 3.2 },
    { month: "الأربعاء", totalDeposits: 4.5, totalBorrowed: 3.3 },
    { month: "الخميس", totalDeposits: 4.7, totalBorrowed: 3.3 },
    { month: "الجمعة", totalDeposits: 4.6, totalBorrowed: 3.2 },
    { month: "السبت", totalDeposits: 4.4, totalBorrowed: 3.1 },
    { month: "الأحد", totalDeposits: 4.3, totalBorrowed: 3.0 },
  ],
  month: [
    { month: "يونيو", totalDeposits: 4.2, totalBorrowed: 3.1 },
    { month: "يوليو", totalDeposits: 4.0, totalBorrowed: 2.9 },
    { month: "أغسطس", totalDeposits: 4.1, totalBorrowed: 3.0 },
    { month: "سبتمبر", totalDeposits: 4.3, totalBorrowed: 3.1 },
    { month: "أكتوبر", totalDeposits: 4.5, totalBorrowed: 3.2 },
    { month: "نوفمبر", totalDeposits: 4.7, totalBorrowed: 3.3 },
    { month: "ديسمبر", totalDeposits: 4.6, totalBorrowed: 3.2 },
    { month: "يناير", totalDeposits: 4.4, totalBorrowed: 3.1 },
    { month: "فبراير", totalDeposits: 4.3, totalBorrowed: 3.0 },
    { month: "مارس", totalDeposits: 4.5, totalBorrowed: 3.2 },
    { month: "أبريل", totalDeposits: 4.8, totalBorrowed: 3.4 },
    { month: "مايو", totalDeposits: 4.7, totalBorrowed: 3.3 },
  ],
};
        ...
        {uniquePayload.map((entry, index) => (
          <div key={index} className="flex items-center gap-2 mb-1">
            ...
            <span className="text-sm text-zinc-300">
              {entry.dataKey === "totalDeposits" ? "إجمالي الودائع" : "إجمالي القروض"}:
            </span>
...
const PERIODS = {
  day: { key: "day", label: "يوم" },
  week: { key: "week", label: "أسبوع" },
  month: { key: "month", label: "شهر" },
} as const;
      ...
      <Card className="w-full rounded-3xl lg:max-w-4xl bg-zinc-950 border-zinc-800 text-white">
        <CardHeader className="min-h-auto gap-5 p-8 border-0">
          <CardHeading className="flex flex-wrap items-end gap-5">
            <div className="min-w-40 space-y-0.5 ms-2.5">
              <div className="text-sm text-zinc-400 mb-1">إجمالي القيمة المقفلة</div>
              <div className="text-3xl leading-none font-bold">
                ${(totalValueLocked * 1000).toLocaleString()}.15
              </div>
            </div>
