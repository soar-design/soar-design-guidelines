...
const salesData = [
  { month: "يناير 24", goals: 250000, sales: 280000, salesArea: 280000 },
  { month: "فبراير 24", goals: 420000, sales: 350000, salesArea: 350000 },
  { month: "مارس 24", goals: 380000, sales: 480000, salesArea: 480000 },
  { month: "أبريل 24", goals: 520000, sales: 390000, salesArea: 390000 },
  { month: "مايو 24", goals: 300000, sales: 520000, salesArea: 520000 },
  { month: "يونيو 24", goals: 550000, sales: 465000, salesArea: 465000 },
];
          ...
          {filteredPayload.map((entry, index) => {
            ...
            return (
              <div key={index} className="flex items-center gap-2 text-xs">
                ...
                {config?.label == "الأهداف" && (
                  <Badge
                    variant={
                      ((entry.value - filteredPayload[0].value) / filteredPayload[0].value) * 100 >
                      0
                        ? "success"
                        : "destructive"
                    }
  ...
  return (
    <div className="w-full flex items-center justify-center p-6 lg:p-8">
      <Card className="w-full lg:max-w-4xl">
        <CardHeader className="border-0 min-h-auto pt-6 pb-6">
          ...
          <CardToolbar>
            <div className="flex items-center gap-4 text-sm">
              ...
              <ChartLabel label="الأهداف" color={chartConfig.goals.color} />
            </div>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="dim" size="sm" mode="icon" className="-ms-1.5">
        ...
        <CardContent className="px-2.5 flex flex-col items-start">
          <ChartContainer
            config={chartConfig}
          ...
          >
            ...
            >
              ...
              <ReferenceLine x="مارس 24" stroke={chartConfig.sales.color} strokeWidth={1} />
