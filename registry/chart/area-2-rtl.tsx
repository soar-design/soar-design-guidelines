...
const conversionFunnelData = {
  "7d": [
    { period: "الاثنين", storeVisits: 2500, productViews: 2100, addToCart: 1400, checkout: 1200 },
    { period: "الثلاثاء", storeVisits: 2800, productViews: 2300, addToCart: 1600, checkout: 1350 },
    { period: "الأربعاء", storeVisits: 1900, productViews: 1500, addToCart: 950, checkout: 780 },
    { period: "الخميس", storeVisits: 3100, productViews: 2600, addToCart: 1800, checkout: 1500 },
    { period: "الجمعة", storeVisits: 2400, productViews: 1900, addToCart: 1200, checkout: 980 },
    { period: "السبت", storeVisits: 3400, productViews: 2800, addToCart: 1950, checkout: 1620 },
    { period: "الأحد", storeVisits: 2100, productViews: 1700, addToCart: 1100, checkout: 850 },
  ],
  "30d": [
    {
      period: "الأسبوع 1",
  ...
  "90d": [
    { period: "يناير", storeVisits: 78000, productViews: 65000, addToCart: 45000, checkout: 37000 },
    { period: "فبراير", storeVisits: 82000, productViews: 68500, addToCart: 48000, checkout: 39500 },
    { period: "مارس", storeVisits: 69000, productViews: 54000, addToCart: 36000, checkout: 28500 },
    { period: "أبريل", storeVisits: 61000, productViews: 47000, addToCart: 31000, checkout: 24000 },
    { period: "مايو", storeVisits: 75000, productViews: 62000, addToCart: 43000, checkout: 35500 },
    { period: "يونيو", storeVisits: 84000, productViews: 71000, addToCart: 49000, checkout: 41000 },
  ],
  "12m": [
    {
      period: "الربع الأول",
...
const PERIODS = {
  "7d": { key: "7d", label: "آخر 7 أيام" },
  "30d": { key: "30d", label: "آخر 30 يوم" },
  "90d": { key: "90d", label: "آخر 90 يوم" },
  "12m": { key: "12m", label: "آخر 12 شهر" },
} as const;
...
const stageMetrics = [
  {
    ...
    label: "زيارات المتجر",
    icon: Store,
    color: chartConfig.storeVisits.color,
  },
  {
    key: "productViews",
    label: "مشاهدات المنتج",
    icon: Eye,
    color: chartConfig.productViews.color,
  },
  {
    key: "addToCart",
    label: "إضافة إلى السلة",
    icon: ShoppingCart,
    color: chartConfig.addToCart.color,
  },
  {
    key: "checkout",
    label: "الدفع",
...
export default function AreaChart2() {
  ...
  const getChangeForMetric = (metric: string) => {
    ...
    return (
      changes[selectedPeriod][metric as keyof (typeof changes)[typeof selectedPeriod]] || 0
    );
  };
    ...
    <div className="w-full flex items-center justify-center p-6 lg:p-8">
      <Card className="w-full max-w-5xl">
        <CardHeader className="border-0 min-h-auto py-6">
          <CardTitle className="text-lg font-semibold">قمع التحويل</CardTitle>
          <CardToolbar>
            {/* Period Selector */}
            <Select
