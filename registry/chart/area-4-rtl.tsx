...
const revenueData = {
  ...
  week: [
    { period: "الاثنين", revenue: 2400 },
    { period: "الثلاثاء", revenue: 2800 },
    { period: "الأربعاء", revenue: 2200 },
    { period: "الخميس", revenue: 3200 },
    { period: "الجمعة", revenue: 2900 },
    { period: "السبت", revenue: 1800 },
    { period: "الأحد", revenue: 2600 },
  ],
  month: [
    { period: "الأسبوع 1", revenue: 16800 },
    { period: "الأسبوع 2", revenue: 18200 },
    { period: "الأسبوع 3", revenue: 15600 },
    { period: "الأسبوع 4", revenue: 19400 },
  ],
  year: [
    { period: "الربع الأول", revenue: 198000 },
    { period: "الربع الثاني", revenue: 225000 },
    { period: "الربع الثالث", revenue: 189000 },
    { period: "الربع الرابع", revenue: 267000 },
  ],
};
  ...
  if (active && payload && payload.length) {
    return (
      <div className="rounded-lg bg-zinc-900 text-white p-3 shadow-lg">
        <div className="text-xs font-medium mb-1">الإيرادات:</div>
    ...
    <div className="w-full flex items-center justify-center p-6 lg:p-8">
      <Card className="w-full lg:max-w-4xl rounded-2xl">
        <CardHeader className="min-h-auto py-6 border-0">
          <CardTitle className="text-xl font-semibold">نظرة عامة على الطلبات</CardTitle>
          <CardToolbar>
            <ToggleGroup
              type="single"
              ...
              >
                ...
                <Area
                  ...
                  dot={(props) => {
                    ...
                    const showDot =
                      (selectedPeriod === "day" &&
                        (payload.period === "08:00" || payload.period === "16:00")) ||
                      (selectedPeriod === "week" &&
                        (payload.period === "الخميس" || payload.period === "السبت")) ||
                      (selectedPeriod === "month" && payload.period === "الأسبوع 2") ||
                      (selectedPeriod === "year" && payload.period === "الربع الثاني");
