...
const engagementData = [
  { time: "6 ص", facebook: 2, instagram: 8, linkedin: 5 },
  { time: "7 ص", facebook: 5, instagram: 12, linkedin: 8 },
  { time: "8 ص", facebook: 8, instagram: 18, linkedin: 15 },
  { time: "9 ص", facebook: 12, instagram: 25, linkedin: 22 },
  { time: "10 ص", facebook: 15, instagram: 35, linkedin: 28 },
  { time: "11 ص", facebook: 18, instagram: 42, linkedin: 32 },
  { time: "12 ظ", facebook: 22, instagram: 38, linkedin: 35 },
  { time: "1 ظ", facebook: 25, instagram: 45, linkedin: 30 },
  { time: "2 ظ", facebook: 28, instagram: 48, linkedin: 33 },
  { time: "3 ظ", facebook: 30, instagram: 52, linkedin: 38 },
  { time: "4 م", facebook: 26, instagram: 46, linkedin: 35 },
  { time: "5 م", facebook: 24, instagram: 44, linkedin: 32 },
  { time: "6 م", facebook: 22, instagram: 40, linkedin: 28 },
  { time: "7 م", facebook: 20, instagram: 38, linkedin: 25 },
  { time: "8 م", facebook: 18, instagram: 35, linkedin: 22 },
];
    ...
    <div className="w-full flex items-center justify-center p-6 lg:p-8">
      <Card className="w-full max-w-2xl">
        <CardHeader className="border-0 pt-6 pb-4">
          <CardTitle className="text-lg font-semibold">نشاط وسائل التواصل الاجتماعي</CardTitle>
          <CardToolbar>
            <DropdownMenu>
        ...
        <CardContent className="pe-0 ps-4.5 pb-6">
          <ChartContainer
            config={chartConfig}
          ...
          <div className="flex items-center justify-center gap-6">
            <ChartLegend label="فيسبوك" color={chartConfig.facebook.color} />
            <ChartLegend label="إنستغرام" color={chartConfig.instagram.color} />
            <ChartLegend label="لينكد إن" color={chartConfig.linkedin.color} />
          </div>
        </CardContent>
      </Card>
    </div>
