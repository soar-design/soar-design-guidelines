          ...
          {["desktop", "mobile"].map((key) => {
            ...
            return (
              <button
                ...
                className="data-[active=true]:bg-muted/50 relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-right even:border-r sm:border-t-0 sm:border-r sm:px-8 sm:py-6"
