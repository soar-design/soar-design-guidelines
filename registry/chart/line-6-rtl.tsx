...
import { Card, CardContent, CardHeader } from "@soar-design/soar-react-components";
import {
  ChartContainer,
  ChartTooltip,
            ...
            {metrics.map((metric) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "cursor-pointer text-start p-4 border-b sm:border-b sm:odd:border-e lg:border-b-0 lg:border-e lg:last:border-e-0 transition-all",
                ...
                >
                  ...
                  <div className="text-xs text-muted-foreground mt-1">
                    من {metric.format(metric.previousValue)}
                  </div>
                </button>
              );
            })}
