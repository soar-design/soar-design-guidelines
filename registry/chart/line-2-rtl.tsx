...
const cashflowData = [
  ...
  { month: "فبراير", value: 2300 },
  { month: "مارس", value: 1900 },
  { month: "أبريل", value: 4800 },
  { month: "مايو", value: 5200 },
  { month: "يونيو", value: 8900 },
  { month: "يوليو", value: 6200 },
  { month: "أغسطس", value: 7100 },
  { month: "سبتمبر", value: 9400 },
  { month: "أكتوبر", value: 10200 },
  { month: "نوفمبر", value: 11100 },
  { month: "ديسمبر", value: 11800 },
];
    ...
    return (
      <>
        <div className="rounded-lg bg-zinc-900 text-white p-3 shadow-lg">
          <div className="text-xs font-medium mb-1">الإجمالي:</div>
...
const PERIODS = {
  "6m": {
    key: "6m",
    label: "6 أشهر",
    dateRange: "01 يوليو - 31 ديسمبر 2024",
  },
  "12m": {
    key: "12m",
    label: "12 شهر",
    dateRange: "01 يناير - 31 ديسمبر 2024",
  },
  "2y": {
    key: "2y",
    label: "سنتان",
    dateRange: "01 يناير 2023 - 31 ديسمبر 2024",
  },
} as const;
    ...
    <div className="w-full flex items-center justify-center p-6 lg:p-8">
      <Card className="w-full lg:max-w-4xl ">
        <CardHeader className="border-0 min-h-auto pt-6 pb-4">
          <CardTitle className="text-lg font-semibold">التدفق النقدي</CardTitle>
          <CardToolbar>
            <Select
              ...
              >
                ...
                <Line
                  ...
                  dot={(props) => {
                    ...
                    if (payload.month === "يونيو" || payload.month === "نوفمبر") {
                      return (
                        <circle
                          key={`dot-${cx}-${cy}`}
                          cx={cx}
