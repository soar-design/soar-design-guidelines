...
const impressionsData = {
  "5D": [
    { period: "الاثنين", impressions: 145.2 },
    { period: "الثلاثاء", impressions: 298.7 },
    { period: "الأربعاء", impressions: 356.4 },
    { period: "الخميس", impressions: 289.1 },
    { period: "الجمعة", impressions: 412.8 },
  ],
  "2W": [
    { period: "الأسبوع 1", impressions: 1245.5 },
    { period: "الأسبوع 2", impressions: 1687.3 },
    { period: "الأسبوع 3", impressions: 1354.9 },
    { period: "الأسبوع 4", impressions: 1892.6 },
    { period: "الأسبوع 5", impressions: 1456.2 },
    { period: "الأسبوع 6", impressions: 2134.7 },
  ],
  "1M": [
    { period: "الأسبوع 1", impressions: 3245.5 },
    { period: "الأسبوع 2", impressions: 4187.3 },
    { period: "الأسبوع 3", impressions: 3654.9 },
    { period: "الأسبوع 4", impressions: 4892.6 },
    { period: "الأسبوع 5", impressions: 4156.2 },
    { period: "الأسبوع 6", impressions: 5234.7 },
    { period: "الأسبوع 7", impressions: 4823.1 },
    { period: "الأسبوع 8", impressions: 5567.4 },
  ],
  "6M": [
    { period: "يناير", impressions: 18745.3 },
    { period: "فبراير", impressions: 22187.7 },
    { period: "مارس", impressions: 19654.2 },
    { period: "أبريل", impressions: 25892.8 },
    { period: "مايو", impressions: 23456.6 },
    { period: "يونيو", impressions: 27234.4 },
  ],
};
          ...
          <CardHeader className="min-h-auto flex-nowrap p-0 border-b border-border pt-1 pb-6 mb-6">
            <CardHeading className="flex items-center gap-2.5 space-y-0">
              ...
              <div className="flex flex-col justify-center gap-1">
                ...
                <p className="text-sm text-muted-foreground">الانطباعات والمشاركة</p>
              </div>
            </CardHeading>
            <CardToolbar>
              <Tooltip>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-600">
                    مقارنة بآخر {selectedPeriod === "5D" ? "أسبوع" : "فترة"}
                  </span>
                </div>
              </div>
