...
const salesViewsData = {
  "7d": [
    { period: "1 أغسطس", sales: 850, views: 620 },
    { period: "5 أغسطس", sales: 920, views: 780 },
    { period: "7 أغسطس", sales: 780, views: 540 },
    { period: "8 أغسطس", sales: 1240, views: 890 },
    { period: "22 أغسطس", sales: 1100, views: 720 },
  ],
  "30d": [
    { period: "الأسبوع 1", sales: 5200, views: 4800 },
    { period: "الأسبوع 2", sales: 6400, views: 5200 },
    { period: "الأسبوع 3", sales: 5800, views: 4600 },
    { period: "الأسبوع 4", sales: 7200, views: 5800 },
    { period: "الأسبوع 5", sales: 6800, views: 5400 },
    { period: "الأسبوع 6", sales: 6200, views: 4900 },
  ],
  "90d": [
    { period: "يناير", sales: 22000, views: 18500 },
    { period: "فبراير", sales: 24800, views: 20200 },
    { period: "مارس", sales: 21400, views: 17800 },
    { period: "أبريل", sales: 26200, views: 21600 },
    { period: "مايو", sales: 25600, views: 20800 },
    { period: "يونيو", sales: 27400, views: 22400 },
    { period: "يوليو", sales: 24800, views: 19600 },
    { period: "أغسطس", sales: 23600, views: 18800 },
    { period: "سبتمبر", sales: 28200, views: 23200 },
  ],
  "12m": [
    { period: "الربع الأول 23", sales: 85000, views: 72000 },
    { period: "الربع الثاني 23", sales: 92000, views: 78000 },
    { period: "الربع الثالث 23", sales: 88000, views: 74000 },
    { period: "الربع الرابع 23", sales: 98000, views: 82000 },
    { period: "الربع الأول 24", sales: 94000, views: 79000 },
    { period: "الربع الثاني 24", sales: 102000, views: 86000 },
    { period: "الربع الثالث 24", sales: 96000, views: 81000 },
    { period: "الربع الرابع 24", sales: 108000, views: 90000 },
  ],
};
    ...
    <div className="w-full flex items-center justify-center p-6 lg:p-8">
      <Card className="w-full max-w-3xl">
        <CardHeader className="border-0 min-h-auto pt-6 pb-4">
          <CardTitle className="text-lg font-semibold">مبيعات التجارة الإلكترونية</CardTitle>
          <CardToolbar>
            {/* Period Selector */}
            <Select
        ...
        <CardContent className="px-2 pb-6">
          ...
          <div className="flex items-center flex-wrap gap-3.5 md:gap-10 px-5 mb-8 text-sm">
            <div className="flex items-center gap-3.5">
              <ChartLabel label="المبيعات" color={chartConfig.sales.color} />
            ...
            <div className="flex items-center gap-3.5">
              <ChartLabel label="المشاهدات" color={chartConfig.views.color} />
              <div className="flex items-center gap-2">
