...
export default function Component() {
  return (
    <div className="relative flex h-96 w-full flex-row items-center justify-center overflow-hidden gap-1.5 [perspective:300px]" dir="rtl">
      <div
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-background rtl:left-auto rtl:right-0 rtl:bg-gradient-to-l"></div>
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-background rtl:right-auto rtl:left-0 rtl:bg-gradient-to-r"></div>
      </div>
    </div>
  );
}
