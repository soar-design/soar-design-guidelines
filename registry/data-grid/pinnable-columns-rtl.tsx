...
export default function DataGridPinnableColumns() {
    ...
    () => [
      {
        ...
        id: "name",
        header: ({ column }) => (
          <DataGridColumnHeader title="الاسم" column={column} />
        ),
        cell: ({ row }) => {
          return (
      ...
      },
      {
        accessorKey: "email",
        header: ({ column }) => (
          <DataGridColumnHeader title="البريد الإلكتروني" column={column} />
        ),
        cell: (info) => (
          <Link
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="الموقع" column={column} />
        ),
        cell: ({ row }) => {
          return (
      ...
      },
      {
        ...
        id: "status",
        header: ({ column }) => (
          <DataGridColumnHeader title="الحالة" column={column} />
        ),
        cell: ({ row }) => {
