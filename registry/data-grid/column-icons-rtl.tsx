...
export default function DataGridColumnIcons() {
    ...
    () => [
      {
        ...
        id: "name",
        header: ({ column }) => (
          <DataGridColumnHeader title="المستخدم" icon={<User />} column={column} />
        ),
        cell: ({ row }) => {
          return (
      ...
      },
      {
        accessorKey: "email",
        header: ({ column }) => (
          <DataGridColumnHeader title="البريد الإلكتروني" icon={<Mail />} column={column} />
        ),
        cell: (info) => (
          <Link
