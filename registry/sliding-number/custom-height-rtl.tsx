  ...
  return (
    <div className="space-y-8" dir="rtl">
      <div className="space-y-2">
        <div className="text-sm text-muted-foreground">صغير (30 بكسل)</div>
        <div className="text-3xl font-bold">
          <SlidingNumber from={0} to={567} duration={2} digitHeight={30} />
        </div>
      </div>
      <div className="space-y-2">
        <div className="text-sm text-muted-foreground">افتراضي (40 بكسل)</div>
        <div className="text-4xl font-bold">
          <SlidingNumber from={0} to={567} duration={2} digitHeight={40} />
        </div>
      </div>
      <div className="space-y-2">
        <div className="text-sm text-muted-foreground">كبير (60 بكسل)</div>
